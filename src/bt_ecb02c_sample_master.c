...
#ifdef BT_ECB02C_USING_SAMPLE_MASTER

#include <drv_common.h>

#define DBG_TAG "bt.ecb02c.master"
...
static int bt_ecb02c_master_init(void)
{
    bt_dev_t dev = bt_create("ecb02c_mst", &cfg);
...
INIT_APP_EXPORT(bt_ecb02c_master_init);
